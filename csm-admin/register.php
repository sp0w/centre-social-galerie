...
if(isset($_POST['register'])){
    ...
    if($result){
        ...
        <div><i class="fas fa-check mr-2"></i>Merci pour votre inscription</div>
    </div>';
    }
    ...
    <div class="container-fluid mx-auto">
        <div class="row justify-content-center">
            <form action="register.php" method="POST" enctype="multipart/form-data">
                ...
                <h1 class=" mb-3 mt-4 text-center">Inscription Administrateur</h1>
                <hr class="mb-3"/>
                ...
                <button type="submit" value="register" name="register" class="btn col-12 mt-2 mb-2"
                    style="background-color: #FF7200;">Inscription
                </button>
