...
<body>
  ...
  <div class="container">
    ...
    <!-- Titre page -->
    <h1 class="font-weight-light text-lg-left mt-4 texte-img">Galerie Secteur Enfant</h1>
    <hr class="mt-2 mb-5">
    <!-- Titre page end -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <img id="image-gallery-image" class="img-thumb col-md-12" src="../csm-admin/">
            </div>
